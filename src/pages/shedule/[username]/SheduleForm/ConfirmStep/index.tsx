...
const confirmFormSchema = z.object({
    name: z.string().min(3, { message: 'O nome precisa de no minimo 3 caracters' }),
    ...
    return (
        <ConfirmForm as='form' onSubmit={handleSubmit(handleConfirmScheduling)}>
            ...
            <FormActions>
                ...
                <Button type="submit" disabled={isSubmitting} onClick={onCancelConfirmation}>Confirmar</Button>
            </FormActions>
